...
<body>
<br>
<p>当前登录用户为：${user.name}</p>
<br>
<div style="color: red"><%=msg%>
</div>
<form action="login" method="post">
    <%-- 用户名<input type="text" name="name" value="jay"><br>
     密码<input type="text" name="password" value="111"><br>--%>

 <%--   用户名<input type="text" name="name"  ${empty cookie.username1.value ? "":value='${cookie.username1.value}'}><br>--%>
